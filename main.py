...
from config import db_manager_conversations, db_manager_userdata, assistant_memory, assistant_sales_detector, assistant_consentiment, assistant_request_data, rag, limit_messages_in_conversation
...
request_consent = "/n/n We have noticed that you seems to be interested in know more deeply about QuantumChain's products and services./n/nIf you would like one of our specialists to contact you and provide more detailed information, please let us know by giving your consent./n/nFeel free to review our [Privacy Policy] if you have any concerns about the security or integrity of your personal data."
